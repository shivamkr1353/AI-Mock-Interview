...
export default function Page() {
  return (
    <section className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-violet-50 to-purple-100 dark:from-slate-900 dark:to-slate-800 p-4">
      <div className="container max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-6 bg-white/80 dark:bg-slate-800/80 backdrop-blur-2xl rounded-3xl shadow-2xl border border-gray-100 dark:border-slate-700 overflow-hidden">
          ...
          <section className="hidden lg:flex relative items-center justify-center p-8 lg:p-12 bg-gradient-to-br from-violet-600 to-purple-700">
            ...
            <div className="w-full max-w-md space-y-8 text-center">
              ...
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  ...
                  <a
                    href="/sign-up"
                    className="ml-2 text-violet-600 hover:text-purple-800 font-semibold"
                  >
                    Create an account
                  </a>
                </p>
