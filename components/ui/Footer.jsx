        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center md:items-start">
            <div className="flex items-center space-x-3 mb-4">
              <h2 className="text-2xl mr-5 font-bold bg-clip-text text-transparent bg-gradient-to-r from-violet-300 to-purple-500">
                AI Mock Interview
              </h2>
            </div>
          ...
          <div className="flex flex-col items-center">
            <h3 className="text-xl font-semibold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-amber-300 to-orange-500">
              Quick Links
            </h3>
              ...
              {[
                ...
                <a
                  ...
                  className="text-gray-300 hover:text-white transition-colors duration-300 
                    relative group"
                >
                  <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-violet-300 to-purple-500 
          ...
          {/* Social Links */}
          <div className="flex flex-col items-center">
            <h3 className="text-xl font-semibold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-teal-300 to-cyan-500">
              Connect
            </h3>
            <div className="flex space-x-6">
              {[
                {
                  name: "GitHub",
                  href: "https://github.com/shivamkr1353",
                  icon: (
                ...
                {
                  name: "LinkedIn",
                  href: "https://www.linkedin.com/in/shivamkumar997386/",
                  icon: (
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-12 pt-8 border-t border-white/10 text-center">
          ...
          <p className="text-xs text-gray-400 mt-2">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-clip-text text-transparent bg-gradient-to-r from-violet-300 to-purple-500 hover:from-amber-300 hover:to-orange-500 transition-all duration-300"
            >
              Shivam
            </a>
          </p>
